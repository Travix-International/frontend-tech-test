...
class TasksGauge extends Component {

  constructor(props) {
    super(props);
    this.tasksPerStatus = props.tasksPerStatus;
}
  ...
  componentDidMount() {
    ...
    chart.data = [
      {
        "category": "Done",
        "value": this.tasksPerStatus.done || 0,
        "full": 100
      },
      {
        "category": "Todo",
        "value": this.tasksPerStatus.todo || 0,
        "full": 100
      },
      {
        "category": "Starred",
        "value": this.tasksPerStatus.starred || 0,
        "full": 100
      },];
