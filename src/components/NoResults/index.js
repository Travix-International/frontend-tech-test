...
const NoResults = () => (
  <div className="noResults card">
    <p className="noResults__emoticon">
      <svg viewBox="0 0 368 368" xmlns="http://www.w3.org/2000/svg">
        <g fill="#fff">
    ...
    <h2 className="card__title">There are no tasks</h2>
    <p className="card__description">Enjoy this moment</p>
  </div>
);
